...
from blueprints.inspector import inspector_blueprint
from blueprints.frontendapis import frontend_blueprint
...
def create_app() -> Flask:
    ...
    register_exceptions(inspector_blueprint,application)
    db.init_app(application)
    application.register_blueprint(inspector_blueprint, url_prefix='/v1/inspector')
    application.register_blueprint(frontend_blueprint, url_prefix='/v1/app')
